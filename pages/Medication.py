...
if os.path.exists(tracker_file):
    medication_tracker = load_tracker()
else:
    medication_tracker = create_tracker_from_history(history_file, tracker_file)
...
if future_df.empty:
    ...
    if st.button("Save Changes"):
        ...
        save_tracker(updated_tracker.to_dict(orient='records'))
